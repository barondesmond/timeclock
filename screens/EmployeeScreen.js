...
return (
	...
	{Jobs}
	{Dispatch}
					   <Button title="Close Screen" onPress={()=>this.setState({isScrenVisible: false})} />
				   </View>
		        </ScrollView>
      </Modal>
...
renderCircle = () => {
	...
	if (this.state.checkinStatus != 'Start' && this.state.checkinStatus != 'Stop' && this.state.checkinStatus != 'Switch')
	{
		return (<View>			
...
if (this.state.auth.Screen == 'Dispatch' && this.state.auth.event == 'Traveling' && this.state.event == 'Working')
{
