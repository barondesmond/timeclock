...
import { Image, Button, Platform, AppState, StyleSheet, Text, View, TouchableOpacity, AsyncStorage, Alert } from 'react-native';
...
saveSignature = async () => {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.containersig}>
          ...
          <View style={styles.buttonContainer}>
			  <Button title="Sign & Accept" onPress={() => this.saveCanvas()} />
			  </View>
